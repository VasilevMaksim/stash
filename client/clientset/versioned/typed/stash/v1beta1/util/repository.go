...
func CreateOrPatchRepository(c cs.StashV1beta1Interface, meta metav1.ObjectMeta, transform func(alert *api.Repository) *api.Repository) (*api.Repository, kutil.VerbType, error) {
...
func PatchRepository(c cs.StashV1beta1Interface, cur *api.Repository, transform func(*api.Repository) *api.Repository) (*api.Repository, kutil.VerbType, error) {
	return PatchRepositoryObject(c, cur, transform(cur.DeepCopy()))
}

func PatchRepositoryObject(c cs.StashV1beta1Interface, cur, mod *api.Repository) (*api.Repository, kutil.VerbType, error) {
...
func TryUpdateRepository(c cs.StashV1beta1Interface, meta metav1.ObjectMeta, transform func(*api.Repository) *api.Repository) (result *api.Repository, err error) {
	attempt := 0
