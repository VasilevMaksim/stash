...
func CreateOrPatchRestoreSession(c cs.StashV1beta1Interface, meta metav1.ObjectMeta, transform func(alert *api.RestoreSession) *api.RestoreSession) (*api.RestoreSession, kutil.VerbType, error) {
...
func SetRestoreSessionStats(c cs.StashV1beta1Interface, recovery *api.RestoreSession, path string, d time.Duration, phase api.RestorePhase) (*api.RestoreSession, error) {
