...
func CreateOrPatchRecovery(c cs.StashV1alpha2Interface, meta metav1.ObjectMeta, transform func(alert *api.Recovery) *api.Recovery) (*api.Recovery, kutil.VerbType, error) {
...
func PatchRecovery(c cs.StashV1alpha2Interface, cur *api.Recovery, transform func(*api.Recovery) *api.Recovery) (*api.Recovery, kutil.VerbType, error) {
	return PatchRecoveryObject(c, cur, transform(cur.DeepCopy()))
}

func PatchRecoveryObject(c cs.StashV1alpha2Interface, cur, mod *api.Recovery) (*api.Recovery, kutil.VerbType, error) {
...
func TryUpdateRecovery(c cs.StashV1alpha2Interface, meta metav1.ObjectMeta, transform func(*api.Recovery) *api.Recovery) (result *api.Recovery, err error) {
	attempt := 0
...
func SetRecoveryStats(c cs.StashV1alpha2Interface, recovery *api.Recovery, path string, d time.Duration, phase api.RecoveryPhase) (*api.Recovery, error) {
